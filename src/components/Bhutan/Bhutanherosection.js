...
import MonthDateTags from './Bhutanavailabledates ';
...
export default function Herosection() {
  ...
  const words = useMemo(() => ['Bhutan', 'Bhutan'], []);
  ...
  return (
    <>
      <div className='container-fluid blue-brand-bg-color p-3 d-flex flex-wrap justify-content-center' >
        <h1 className='keyword-title text-center text-white m-0'>Bhutan Tour Package from Bangalore
</h1>
      </div>
          ...
          <div className='row align-items-center'>
            <div className='col-12 col-md-7 px-md-5 py-3'>
              ...
              <div className='row g-0 p-3 px-md-5'>
                <div className='col-12 col-sm-5 blue-brand-bg-color text-white d-flex align-items-center justify-content-center p-3'>
