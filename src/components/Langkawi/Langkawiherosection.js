...
import BhutanForm from './Langkawiform';
import MonthDateTags from './Langkawiavailabledates ';
  ...
  return (
    <>
      <div className='container-fluid blue-brand-bg-color p-3 d-flex flex-wrap justify-content-center' >
        <h1 className='keyword-title text-white m-0'>Best Langkawi Package From Bangalore</h1>
      </div>
          ...
          <div className='row align-items-center'>
            <div className='col-12 col-md-7 px-md-5 py-3'>
              <div className="m-0">
                ...
                <h2 className='package-title blue-brand-color m-0'>Langkawi</h2>
