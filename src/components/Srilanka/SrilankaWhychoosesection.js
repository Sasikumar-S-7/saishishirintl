  ...
  <div className="col-12 col-md-6 col-lg-6 text-start">
    <div className={`${styles.ctaSection} p-4 p-md-5 ${isVisible ? styles.fadeInUp : ''}`}>
      <h3 className={`${styles.ctaTitle} mb-4`} style={{ color: '#0b4878' }}>
       Why Choose a Sri Lanka Trip?
      </h3>
      <div className="text-start">
        {[
         "Stunning Beaches – Enjoy golden sands and clear waters at Mirissa, Bentota & Hikkaduwa.",
"Cultural Heritage – Explore UNESCO sites like Sigiriya, Kandy Temple & Dambulla Caves.",
"Scenic Hill Stations – Visit Nuwara Eliya and Ella for tea gardens and cool weather.",
"Wildlife Adventures – Safari at Yala or Udawalawe National Park for elephants & leopards.",
"Iconic Train Rides – Experience the world-famous Kandy to Ella train journey.",
"Delicious Cuisine – Taste spicy curries, seafood, hoppers & fresh tropical fruits.",
"Relaxation & Wellness – Try Ayurvedic spas and beachside yoga retreats.",
"Affordable Luxury – Get high-value experiences at pocket-friendly prices."
        ].map((point, index) => (
