  ...
  const slides = [
    {
      ...
      mobileImage: '/srilanka/Srilanka-mobile-4.webp',
      title: 'srilanka Cultural Tour',
    //   description: 'Experience the rich heritage of srilanka with our exclusive packages from Bangalore'
    },
    {
      id: 2,
      desktopImage: '/srilanka/Srilanka-2.webp',
      mobileImage: '/srilanka/Srilanka-mobile-2.webp',
      title: 'Himalayan Adventures',
    //   description: 'Trek through breathtaking landscapes with our expert guides'
    },
    {
      id: 3,
      desktopImage: '/srilanka/Srilanka-3.webp',
      mobileImage: '/srilanka/Srilanka-mobile-3.webp',
      title: 'All-Inclusive Packages',
    //   description: 'Flights, accommodation, meals and sightseeing - we handle it all!'
    },
     {
      id: 4,
      desktopImage: '/srilanka/Srilanka-4.webp',
      mobileImage: '/srilanka/Srilanka-mobile-1.webp',
      title: 'All-Inclusive Packages',
    //   description: 'Flights, accommodation, meals and sightseeing - we handle it all!'
    }
  ];
